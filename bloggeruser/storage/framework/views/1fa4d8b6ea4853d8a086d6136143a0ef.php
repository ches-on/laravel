            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-secondary sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" style='color:white' href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                        </li> 
                         <?php endif; ?>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style='color:white' href="<?php echo e(route('register')); ?>">Register</a>
                        </li>
...
<?php /**PATH C:\xampp\htdocs\bloggeruser\resources\views/layout.blade.php ENDPATH**/ ?>